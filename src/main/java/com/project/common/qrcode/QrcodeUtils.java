package com.project.common.qrcode;
...
public class QrcodeUtils {
     ...
     * @throws Exception
     */
    public static void qrcodeToOutputStream(String content , int length, String format, OutputStream outputStream)
    throws Exception {
        BitMatrix bitMatrix = createQrcodeMatrix(content, length);
